...
const [serverUrl, setServerUrl] = useState('http://localhost:9090/render');
	...
	const handleDemo = async () => {
		...
		setPanels([{ mode: 'high-graphics-dot-matrix-3d', color, band: 'full', colors: { low: '#00d08a', mid: '#7aa2ff', high: '#ff6b6b' }, hgView: 'top' }]);
		setShowDancer(true);
		setDancerPos('mm');
		setDancerSize(100);
		setDancerOverlaySources({ characterUrl: '/character/Big Vegas.fbx', animationUrls: ['/dance/Silly Dancing.fbx', '/dance/Swing Dancing.fbx', '/dance/Twist Dance.fbx', '/dance/Wave Hip Hop Dance.fbx'] });
